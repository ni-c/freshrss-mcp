...
![Demo: listing the tools, the subscribed feeds and the newest article through the MCP Inspector CLI](/demo.gif)

## Running it elsewhere

A client that cannot spawn a local process — ChatGPT connectors, Claude on the web,
Cursor, LibreChat — cannot start freshrss-mcp the way Claude Code does.
