...
export const article = z.looseObject({
  ...
  enclosures: z.array(z.looseObject({ url: z.string().optional() })).optional(),
  content: z.string().optional().describe('Only with include_content.'),
  contentTruncated: z.literal(true).optional(),
  contentOmitted: z
    .literal('budget')
    .optional()
    .describe('The total content budget was already spent on earlier entries.'),
  excerpt: z
    .string()
    .optional()
...
export const feed = z.looseObject({
